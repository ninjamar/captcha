...
(async () => {
    let font = await loadGoogleFont({family: "Source Code Pro", weight: 600});
    let data = Buffer.from(font).toString("base64");
    fs.writeFileSync("./fontdata.js", `export const FONTDATA = "${data}"`);
})();